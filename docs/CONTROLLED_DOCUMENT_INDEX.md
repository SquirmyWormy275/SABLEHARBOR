...
[Facility programme, individual campus/building/floor plans and atlas](../geospatial/facilities/README.md) — R02 / v0.2.0 modelled September 2026 planning successor; approved R01 references preserved, final QA and release gates pending.
...
- [Corporate headquarters closeout](canon/CORPORATE_HEADQUARTERS_CLOSEOUT_2026-09-03.md) — controlling synthesis for ESS, OGC, Risk & Compliance, Finance, People & Culture, Technology Services, decision/autonomy doctrine, capital/planning rhythm, executive architecture, professional practices, portfolio architecture, and Sacramento headquarters physical doctrine
...
- [CCF foundation index](controls/CCF_FOUNDATION_BUILD_INDEX_v0.1.md)
- [CCF governance/J2 integration](controls/CCF_GOVERNANCE_J2_INTEGRATION_v0.1.md)
- [Organization package](organization/README.md)
- [Wiki source](wiki/README.md)

## Historical and superseded governance records
