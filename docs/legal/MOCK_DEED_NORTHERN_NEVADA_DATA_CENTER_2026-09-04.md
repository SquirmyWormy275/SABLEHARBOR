...
**Planning estate:** fee-simple-equivalent ownership in the Sable Harbor planning universe, subject to ordinary utility, access, code, environmental, tax, and development obligations.

## Planning description

A fictional approximately **7.5-acre** industrial parcel situated within the Tahoe-Reno Industrial Center / USA Parkway industrial district of Storey County, Nevada, centered for planning purposes near **39.5450 N, 119.4550 W**.

The coordinate is a planning anchor only. The planning parcel boundary must be generated as clearly synthetic geometry and must not trace, appropriate, or imply ownership of a real cadastral parcel. No assessor parcel number, recording number, legal metes-and-bounds description, title-company file, easement instrument, or surveyed boundary is represented.

## Intended use

Development of the SABLE HARBOR Northern Nevada Data Center and associated secure utility, network, security, operations, loading, cooling, generator, energy-storage, and future expansion infrastructure.

## Planning reservations

The planning conveyance is subject to: utility and carrier rights; access/fire requirements; drainage/stormwater requirements; permitting and code compliance; environmental restrictions; security setbacks; and future survey/design refinement. None of these are represented as executed real-world easements.
...
This mock deed may support fictional/canon accounting and map state only. It must never be submitted to a government recorder, lender, insurer, title company, real-estate counterparty, tax authority, or other real-world party as evidence of ownership.
