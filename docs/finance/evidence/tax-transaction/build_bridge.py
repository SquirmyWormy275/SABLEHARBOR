...
def build():
    ...
    record = {
        ...
        "boundaries": [
            ...
            "Red Wash pre-close day dates conflict across summaries/instruments; July18 2025 close and28M price agree; no date reconciliation inferred.",
            "Northern Nevada3M land acquisition is later runtime canon, not part of this scoped release/tax bridge; settlement remains unresolved.",
        ],
    }
...
| [Debt](aru_2026_debt.csv) | Complete2026 term/revolver/lease schedule |
| [Assets](aru_2026_assets.csv) | Complete2026 owned/leased depreciation schedule |
