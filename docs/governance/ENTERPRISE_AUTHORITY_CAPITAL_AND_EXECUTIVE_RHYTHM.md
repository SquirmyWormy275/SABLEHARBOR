...
Documentation is triggered by stakes, not habit. Routine low-consequence decisions need no ritual record. Consequential decisions should preserve enough to remain legible: owner, material evidence, serious alternatives, material dissent, reasoning, and what would trigger reconsideration.
