...
- [Red Wash Transaction and Operating Record](SH-PS-RW-TOR-001_v1.1.0.pdf), using the owner-approved Pale Sun source identity; and
- [ARU/BS&T Interface and Dependency Record](SH-PS-RW-LOG-001_v1.1.0.pdf), using the owner-approved Red Wash source identity.
...
The earlier v1.0.0 mine PDFs remain preserved historical representations. Current industrial company publications are indexed in the [industrial case](../../../industrial/README.md); the source/PDF manifest identifies each current pair.
