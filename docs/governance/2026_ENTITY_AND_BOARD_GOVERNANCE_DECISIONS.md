...
- **American Resource Utility (ARU)** remains a true controlled subsidiary because it entered Sable Harbor through acquisition and remains a distinct operating company during integration.
- **Blood, Sweat & Tears Railway (BS&T)** is a wholly owned legal subsidiary beneath ARU rather than merely a brand or department. This preserves the railway's asset, operating, regulatory, and accounting boundary while keeping it within the ARU group.
- **Red Wash** is operated through a dedicated legal operating company rather than directly by the software parent. Pale Sun remains the strategic/operating business line associated with uranium; it is not itself made a legal entity merely by virtue of the program name.
- Exact legal names, states of formation, ownership percentages where not 100%, tax elections, financing entities, mineral/land holding entities, and intercompany agreements remain implementation work unless they materially change canon.

## 2. Board architecture — LOCKED

Sable Harbor uses a **unitary U.S.-style board**, not a two-tier supervisory/management-board structure.
...
5. **Technology & Operations Committee** — technology strategy, cybersecurity, product and AI governance, operational technology, major reliability/technology incidents, and material operational/safety interfaces.

A specialized government-security or federal-program committee is **not** automatically created. It may arise later if Pale Sun's actual federal/security boundary warrants one.

## 3. Chair and founder representation — LOCKED

The CEO and Chair roles are separate.

### Margaret "Maggie" Kincaid — LOCKED

Maggie Kincaid is an independent director with substantial mining/industrial operating and governance experience. She joined during Sable Harbor's professionalization period and became independent Chair in 2024.

Her governance function is not to displace management. She reinforces explicit decision rights, escalation, post-investment accountability, and board discipline as Sable Harbor evolves from a software company with mining customers into a more complicated technology-and-industrial group.

### Founder seats — LOCKED DIRECTION

- Daniel remains CEO and a director but is not Chair.
- Priya remains a founder director.
- Jon Bell remains a non-management founder director after leaving the executive team.

## 4. Audit & Compliance leadership — LOCKED

### Thomas "Tom" Calder

Tom Calder is an independent director and chairs the Audit & Compliance Committee. His background is as an experienced industrial/public-company finance executive with significant acquisition, financial-reporting, and control-environment experience.
...
The capital history should include:

- an earlier technology/growth investor associated with the transition from founder-led services to scalable software; and
- a later, larger, long-duration industrial investor associated with Sable Harbor's 2022 growth phase and its increasing willingness to operate across software, industrial, and physical-asset boundaries.
...
These decisions allow the CCF to distinguish:

- parent-level controls from subsidiary-level controls;
...
External frameworks remain mappings and assessment lenses. They did not determine these corporate design choices.

## 7. Still open

The following remain open and must not be silently invented as locked facts:
