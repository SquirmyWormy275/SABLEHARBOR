...
- `decide(records_by_id, record_id, subject, action, now, revoked_ids=(), tombstones=())`: ALLOW/DENY, offset-qualified instants, tenant/purpose matching, no future source availability and transitive restrictions.
