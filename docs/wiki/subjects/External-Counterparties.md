...
| Corporate service and infrastructure providers | Third parties with separately recorded selection, contract and deployment status. A selected brand is not an installed service or owned building. | [Services register and guide](../../../enterprise/services/README.md), [runtime estate](../../../enterprise/runtime/README.md) |

For a transaction exercise, follow the [Red Wash transaction file](../../../industrial/transaction/01_RW_TRANSACTION_FILE.md) into its native schedules. Seller proceeds do not make seller-wide books part of consolidation. [External counterparties chart](../../organization/charts/external-counterparties.md) retains its source qualifications; the [legal ownership chart](../../organization/charts/industrial-ownership.md) answers a different question.
