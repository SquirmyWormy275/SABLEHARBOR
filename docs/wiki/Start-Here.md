...
[Wiki home](Home.md) · [Businesses](businesses/README.md) · [Departments](departments/README.md) · [Document library](Library.md)

Sable Harbor is a fictional enterprise archive built for serious reading and practical exercises. You can explore how its businesses work, inspect the records behind a decision or complete a bounded accounting or controls exercise. No software installation is needed to read the Wiki.

## Explore the company

Start with a [business](businesses/README.md). Read its introduction and reading guide, then follow the operating dossier into its people, finances and places. The [department directory](departments/README.md) explains the corporate functions and institutions that support or review that work.
...
A fictional record can still distinguish a proposal, an accepted institutional decision, an execution record and a generated model. Read the [short glossary](Glossary.md) and each article's **What remains unknown** section before drawing a conclusion.

The [open questions register](Open-Questions.md) describes the remaining evidence and decisions. The [source and format guide](../reader/SOURCES_AND_FORMATS.md) explains authority when records disagree.
