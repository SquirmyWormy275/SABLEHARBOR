...
- [Structured approval register](../../../docs/governance/structured/board_approval_records.json) — Locate dated approval objects and source references.
- [Controlled document standard](../../../docs/governance/CORPORATE_DOCUMENT_STANDARD_v0.1.md) — Document identification, control and publication requirements.
