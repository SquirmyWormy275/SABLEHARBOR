...
- [Transaction data room](../../../docs/finance/TRANSACTION_DATA_ROOM_INDEX.md) — Locate supporting transaction records.
- [Accounting policies](../../../docs/finance/ACCOUNTING_POLICIES.md) — Interpret recognition and posting assumptions.
- [Excel model guide](../../../docs/finance/EXCEL_MODEL_GUIDE.md) — Find the workbook reading instructions.
- [Database and accounting architecture](../../../docs/finance/DATABASE_AND_ACCOUNTING_ARCHITECTURE.md) — Follow accounts, journal and reporting relationships.
- [Known limitations](../../../docs/finance/KNOWN_LIMITATIONS.md) — Read the scope limits before treating an exercise as complete books.
- [Finance authority](../../../docs/canon/CORPORATE_HEADQUARTERS_CLOSEOUT_2026-09-03.md) — Section 5 defines financial authority and its limits.
