...
- [ESS and independence doctrine](../../../docs/governance/ENTERPRISE_SUPPORT_SERVICES_AND_INDEPENDENCE.md) — Controlling membership and authority boundaries.
- [Corporate headquarters closeout](../../../docs/canon/CORPORATE_HEADQUARTERS_CLOSEOUT_2026-09-03.md) — Enterprise support, professional practices and physical separation requirements.
- [Services inventory](../../../enterprise/services/README.md) — Find service recipients, responsible roles, suppliers and conditional cost/capacity requirements.
- [Controlled ESS publication](../../../docs/governance/publications/SH-GOV-ESS-001_v1.1.0.pdf) — Download the reader edition.
