...
| [Controls, services and runtime](library/controls.md) | 65 |
...
The inventory contains 743 Markdown files, 411 PDFs and 9 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
