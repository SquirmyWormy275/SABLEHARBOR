...
| [Implementation, source guides and delivery evidence](library/technical.md) | 105 |

## Format coverage

The inventory contains 895 Markdown files, 440 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
