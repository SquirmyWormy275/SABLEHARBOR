...
| [People, governance and departments](library/people.md) | 230 |
| [Finance, transactions and operating cases](library/finance.md) | 456 |
| [Controls, services and runtime](library/controls.md) | 79 |
| [Geography and facilities](library/places.md) | 309 |
| [Identity and collateral](library/identity.md) | 15 |
| [Canon, history and decisions](library/history.md) | 45 |
| [Reader guides and subject pages](library/reader.md) | 77 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 99 |

## Format coverage

The inventory contains 885 Markdown files, 439 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
