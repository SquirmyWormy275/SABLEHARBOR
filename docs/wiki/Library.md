...
| [Finance, transactions and operating cases](library/finance.md) | 438 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 89 |

## Format coverage

The inventory contains 850 Markdown files, 434 PDFs and 48 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
