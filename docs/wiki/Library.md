...
| [Finance, transactions and operating cases](library/finance.md) | 458 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 114 |

## Format coverage

The inventory contains 904 Markdown files, 440 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
