...
| [Implementation, source guides and delivery evidence](library/technical.md) | 111 |

## Format coverage

The inventory contains 901 Markdown files, 440 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
