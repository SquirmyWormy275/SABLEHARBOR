...
| [Implementation, source guides and delivery evidence](library/technical.md) | 86 |

## Format coverage

The inventory contains 755 Markdown files, 337 PDFs and 4 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
