...
| [Controls, services and runtime](library/controls.md) | 76 |
...
The inventory contains 875 Markdown files, 438 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
