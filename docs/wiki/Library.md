...
| [Finance, transactions and operating cases](library/finance.md) | 454 |
...
The inventory contains 881 Markdown files, 439 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
