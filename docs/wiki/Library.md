...
| [Finance, transactions and operating cases](library/finance.md) | 452 |
| [Controls, services and runtime](library/controls.md) | 77 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 97 |

## Format coverage

The inventory contains 877 Markdown files, 439 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
