...
| [Reader guides and subject pages](library/reader.md) | 73 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 84 |

## Format coverage

The inventory contains 761 Markdown files, 411 PDFs and 9 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
