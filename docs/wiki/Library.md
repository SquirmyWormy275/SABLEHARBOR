...
| [Finance, transactions and operating cases](library/finance.md) | 273 |
...
The inventory contains 777 Markdown files, 354 PDFs and 21 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
