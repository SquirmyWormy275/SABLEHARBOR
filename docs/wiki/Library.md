...
| [Finance, transactions and operating cases](library/finance.md) | 337 |
...
The inventory contains 820 Markdown files, 359 PDFs and 42 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
