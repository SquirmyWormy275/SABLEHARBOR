...
| [Geography and facilities](library/places.md) | 285 |
...
The inventory contains 646 Markdown files, 330 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
