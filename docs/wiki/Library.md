...
| [Implementation, source guides and delivery evidence](library/technical.md) | 90 |

## Format coverage

The inventory contains 851 Markdown files, 434 PDFs and 48 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
