...
| [People, governance and departments](library/people.md) | 231 |
| [Finance, transactions and operating cases](library/finance.md) | 466 |
...
| [Canon, history and decisions](library/history.md) | 48 |
| [Reader guides and subject pages](library/reader.md) | 77 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 116 |

## Format coverage

The inventory contains 912 Markdown files, 446 PDFs and 48 Excel workbooks. The existing publication manifest verifies 141 Markdown/PDF pairs.
