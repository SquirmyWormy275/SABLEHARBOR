...
| [Finance, transactions and operating cases](library/finance.md) | 451 |
| [Controls, services and runtime](library/controls.md) | 73 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 94 |

## Format coverage

The inventory contains 869 Markdown files, 438 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
