...
| [Geography and facilities](library/places.md) | 291 |
...
The inventory contains 650 Markdown files, 332 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
