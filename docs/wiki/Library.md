...
| [Controls, services and runtime](library/controls.md) | 60 |
...
The inventory contains 667 Markdown files, 336 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
