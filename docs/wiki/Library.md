...
| [Geography and facilities](library/places.md) | 294 |
...
The inventory contains 652 Markdown files, 333 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
