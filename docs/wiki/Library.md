...
| [Finance, transactions and operating cases](library/finance.md) | 245 |
...
The inventory contains 738 Markdown files, 355 PDFs and 9 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
