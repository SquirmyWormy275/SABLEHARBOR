...
| [Geography and facilities](library/places.md) | 296 |
...
The inventory contains 653 Markdown files, 334 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
