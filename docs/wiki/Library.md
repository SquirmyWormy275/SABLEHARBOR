...
| [Implementation, source guides and delivery evidence](library/technical.md) | 98 |

## Format coverage

The inventory contains 878 Markdown files, 439 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
