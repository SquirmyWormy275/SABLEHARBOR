...
| [Finance, transactions and operating cases](library/finance.md) | 300 |
...
The inventory contains 796 Markdown files, 354 PDFs and 31 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
