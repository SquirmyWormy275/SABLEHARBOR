...
| [Geography and facilities](library/places.md) | 288 |
...
The inventory contains 648 Markdown files, 331 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
