...
| [Finance, transactions and operating cases](library/finance.md) | 307 |
| [Controls, services and runtime](library/controls.md) | 66 |
| [Geography and facilities](library/places.md) | 301 |
| [Identity and collateral](library/identity.md) | 15 |
| [Canon, history and decisions](library/history.md) | 41 |
| [Reader guides and subject pages](library/reader.md) | 66 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 81 |

## Format coverage

The inventory contains 747 Markdown files, 411 PDFs and 9 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
