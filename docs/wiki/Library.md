...
| [Finance, transactions and operating cases](library/finance.md) | 340 |
...
The inventory contains 824 Markdown files, 359 PDFs and 42 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
