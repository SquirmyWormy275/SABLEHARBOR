...
| [Finance, transactions and operating cases](library/finance.md) | 308 |
| [Controls, services and runtime](library/controls.md) | 70 |
| [Geography and facilities](library/places.md) | 302 |
...
The inventory contains 802 Markdown files, 354 PDFs and 34 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
