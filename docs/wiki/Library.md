...
| [Geography and facilities](library/places.md) | 282 |
...
The inventory contains 644 Markdown files, 329 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
