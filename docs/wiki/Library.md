...
| [Geography and facilities](library/places.md) | 298 |
...
The inventory contains 654 Markdown files, 335 PDFs and 3 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
