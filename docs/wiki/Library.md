...
| [Finance, transactions and operating cases](library/finance.md) | 216 |
...
| [Reader guides and subject pages](library/reader.md) | 64 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 80 |

## Format coverage

The inventory contains 730 Markdown files, 337 PDFs and 4 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
