...
| [People, governance and departments](library/people.md) | 234 |
| [Finance, transactions and operating cases](library/finance.md) | 469 |
...
| [Canon, history and decisions](library/history.md) | 51 |
| [Reader guides and subject pages](library/reader.md) | 77 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 121 |

## Format coverage

The inventory contains 921 Markdown files, 451 PDFs and 48 Excel workbooks. The existing publication manifest verifies 146 Markdown/PDF pairs.
