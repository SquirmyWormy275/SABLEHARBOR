...
| [People, governance and departments](library/people.md) | 229 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 96 |

## Format coverage

The inventory contains 876 Markdown files, 438 PDFs and 48 Excel workbooks. The existing publication manifest verifies 135 Markdown/PDF pairs.
