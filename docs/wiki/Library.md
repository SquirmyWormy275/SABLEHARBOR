...
| [Reader guides and subject pages](library/reader.md) | 72 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 84 |

## Format coverage

The inventory contains 749 Markdown files, 337 PDFs and 4 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
