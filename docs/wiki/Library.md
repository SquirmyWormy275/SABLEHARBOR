...
| [Reader guides and subject pages](library/reader.md) | 40 |
| [Implementation, source guides and delivery evidence](library/technical.md) | 79 |

## Format coverage

The inventory contains 704 Markdown files, 337 PDFs and 4 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
