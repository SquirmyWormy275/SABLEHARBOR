...
| [Finance, transactions and operating cases](library/finance.md) | 306 |
...
| [Implementation, source guides and delivery evidence](library/technical.md) | 80 |

## Format coverage

The inventory contains 744 Markdown files, 411 PDFs and 9 Excel workbooks. The existing publication manifest verifies 131 Markdown/PDF pairs.
