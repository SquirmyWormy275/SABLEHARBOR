# Foundry and Customer Delivery

**SH-ORG-PEOPLE-FOUNDRY-FIELD · 2026-09-09 · v1.0.0**

Named role membership only; no person-to-person reporting relationship is inferred.

![Foundry and Customer Delivery](../assets/current/people-foundry-field.png)

[Vector artwork](../assets/current/people-foundry-field.svg) · [Complete chart book](../assets/current/Sable-Harbor-Organization-Charts.pdf)
...
| Nadia | Software Engineer | Year not recorded |
...
- **Nadia:** Do not merge with discarded governance identities. Year basis: not recorded Title status: PROPOSED_PLAIN_TITLE
...
- [docs/canon/DECISION_REGISTER_v0.3.1.md](../../../docs/canon/DECISION_REGISTER_v0.3.1.md)
