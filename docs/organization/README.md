...
| ID | Chart | Scope |
|---|---|---|
| `SH-ORG-001` | [SABLE HARBOR — ENTERPRISE ORGANIZATION](2026_OPERATING_TOPOLOGY.md) | August 31 functional operating-line baseline; later headquarters institutions remain controlled by the September 3 closeout. |
...
| `SH-ORG-006` | [PALE SUN / RED WASH — ORGANIZATION](PALE_SUN_RED_WASH_ORGANIZATION.md) | Operating-business and mine-authority organization, approved 140-FTE case split, and qualified interfaces. |
...
| `SH-ORG-008` | [ARU / BS&T — ORGANIZATION](ARU_BST_ORGANIZATION.md) | Distinct acquired operator, named retained leadership, 131-FTE case and gated Red Wash interface. |
