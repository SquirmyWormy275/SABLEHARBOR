...
flowchart TB
    SH["SABLE HARBOR"]
    PALE["PALE SUN<br/>uranium operating business<br/><b>operation first; proving ground second</b>"]
    REDWASH["RED WASH MINE<br/>fictional underground Wyoming uranium mine<br/>selective mining · stockpiles · crushing and milling · uranium concentrate"]

    MARI["Marianne “Mari” Varela<br/><b>leads Pale Sun's operating thesis</b><br/>career underground operator<br/>protects the mine from becoming a technology demonstration"]
    COLE["Cole — surname OPEN<br/><b>Red Wash site superintendent</b><br/>operational continuity and meaningful temporary stop authority"]
...
```mermaid
flowchart LR
    WILLOW["Willow experiment"]
    FOUNDRY["Foundry substrate or Foundry Field product change"]
    ATLAS["Atlas Meridian investigation or capability"]
    OTHER["Any other Sable Harbor unit"]

    GATE["FIELD-QUALIFICATION + OPERATING-OWNER GATE<br/>work must be qualified before entering production"]
    REDWASH["Red Wash production operation"]

    CALEB["Caleb Hargrove<br/><b>owns or strongly influences field operations and experimental qualification</b>"]
    PALE["Pale Sun operating accountability"]
    COLE["Cole<br/><b>defined temporary stop authority</b>"]
    ...
    CALEB -->|qualification authority / influence| GATE
    PALE -->|operating ownership and immediate consequence| GATE
    GATE -->|only qualified work enters| REDWASH
    COLE -->|may halt when observed conditions materially differ| REDWASH
```
