...
The owner need not supply control crosswalks or choose implementation mechanics. The next scoped proposal should identify the first service/customer offering, relevant health-data role and flows, proposed SOC 2 categories/report type, and any commercial deadline. Existing six material-decision packets remain separate. This direction authorizes preparation toward external assessment, not a claim of passing one.
