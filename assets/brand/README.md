...
| Northstar Minerals, Inc. | External Wyoming mining company; Red Wash seller represented by Henry Norwood. | [Horizontal PNG](logos/northstar-minerals__primary-horizontal.png), controlled by [NMI-VIS-001](../../docs/canon/NORTHSTAR_MINERALS_VISUAL_IDENTITY_2026-09-07.md) and [visual manifest](northstar_minerals_visual_manifest.json). |
...
Northstar Minerals, Inc.'s exact approved PNG overrides the general SVG-first rule. Preserve the full star/strata emblem and company lettering as a single horizontal source image.
