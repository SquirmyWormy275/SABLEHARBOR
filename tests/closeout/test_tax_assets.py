...
from enterprise.closeout.tax_assets import build, ca_depreciation, federal_depreciation
...
def test_land_cip_and_nonpurchase_transfer_do_not_create_tax_cohorts():
    ...
    result = {
        "journal_rows": [
            row("LEG_1500", 9000000, 0),
            row("RT_LAND", 20000),
            row("RT_CIP", 30000),
            row("BIZ_PPE", 5000, journal="transfer"),
            row("BIZ_PPE", -5000, journal="transfer"),
            row("RT_IT", 4000),
            row("1000", -54000),
        ],
        "legal_trial_balance_rows": [],
    }
