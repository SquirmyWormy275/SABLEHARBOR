...
class MineProductionBatch(GenerationOwnedMixin, Base):
    ...
    batch_number: Mapped[str] = mapped_column(String(40))
    ...
    __table_args__ = (UniqueConstraint("generation_run_id", "batch_number"),)
...
class UraniumShipment(GenerationOwnedMixin, Base):
    ...
    shipment_number: Mapped[str] = mapped_column(String(40))
    ...
    __table_args__ = (UniqueConstraint("generation_run_id", "shipment_number"),)
