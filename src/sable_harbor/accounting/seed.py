...
def seed_smoke(session: Session) -> str:
    ...
    session.add_all(
        [
            ...
            Account(
                id=stable_id("account", "4030"),
                code="4030",
                name="Uranium revenue",
                account_class="REVENUE",
                normal_balance="CREDIT",
            ),
            Account(
            ...
            Account(
                id=stable_id("account", "4020"),
                code="4020",
                name="Atlas Meridian revenue",
                account_class="REVENUE",
                normal_balance="CREDIT",
            ),
            Account(
                id=stable_id("account", "6000"),
                code="6000",
