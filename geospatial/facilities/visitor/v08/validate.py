...
with Image.open(BASE / "artifacts/visitor-map-v08.png") as image:
    image.verify()
with fitz.open(BASE / "artifacts/visitor-map-v08.pdf") as doc:
...
print(
    "PASS V08 artifact/link integrity and V07 preservation. Illustrative geometry is NOT certified."
)
