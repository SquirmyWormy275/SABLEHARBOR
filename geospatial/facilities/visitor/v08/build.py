...
pdf.set_metadata(
    {
        "title": "Sable Harbor visitor illustration V08 — not a metric plan",
        "author": "Sable Harbor",
...
manifest = {
    ...
    "artifacts": {
        ext: {
            "path": str((BASE / f"artifacts/visitor-map-v08.{ext}").relative_to(ROOT)),
            "sha256": sha(BASE / f"artifacts/visitor-map-v08.{ext}"),
        }
        for ext in ["png", "pdf"]
    },
}
