...
ET.parse(BASE / "artifacts/visitor-map-v02.svg")
doc = fitz.open(BASE / "artifacts/visitor-map-v02.pdf")
assert len(doc) == 1
page = doc[0]
...
import subprocess
import sys
subprocess.run([sys.executable, str(BASE.parent / "validate.py")], check=True)
