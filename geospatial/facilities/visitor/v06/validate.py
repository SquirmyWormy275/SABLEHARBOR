...
with Image.open(BASE / "artifacts/visitor-map-v06.png") as image:
    image.verify()
with fitz.open(BASE / "artifacts/visitor-map-v06.pdf") as doc:
...
print(
    "PASS V06 artifact/link integrity and V02 preservation. Illustrative geometry is NOT certified."
)
