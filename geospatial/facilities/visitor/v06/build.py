...
pdf.set_metadata(
    {
        "title": "Sable Harbor visitor illustration V06 — not a metric plan",
        "author": "Sable Harbor",
...
manifest = {
    ...
    "artifacts": {
        ext: {
            "path": str((BASE / f"artifacts/visitor-map-v06.{ext}").relative_to(ROOT)),
            "sha256": sha(BASE / f"artifacts/visitor-map-v06.{ext}"),
        }
        for ext in ["png", "pdf"]
    },
}
