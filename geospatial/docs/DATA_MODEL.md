...
The package combines enterprise search envelopes and source claims with the accepted industrial case. It contains active Bedford/Fairmont and Fort/Hazelwood study geography, a separately marked superseded Belle envelope, the approved Red Wash anchor, Taylor A hub, connected industrial railway graph, truck road, facilities, structure points and track-register geometries. Unlocated site components are object records without fabricated coordinates. Federal reference layers are separate from fictional assets.

Facility envelopes are produced by the existing industrial generator, preserving declared acreage, aspect ratio and synthetic status. They are not cadastral parcels. Route-mile totals exclude parallel yard tracks; upstream IDs and source hashes remain traceable.
